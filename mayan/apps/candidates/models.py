...
from .managers import CandidatesOptionsManager


class CandidatesOptions(models.Model):
    """
    ...
    user = models.OneToOneField(
        on_delete=models.CASCADE, related_name='candidates_options',
    ...
    objects = CandidatesOptionsManager()
